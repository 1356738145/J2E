...
script_config = {
    "买家购买决策分析": {
        ...
        "allowed_columns": ["deepseek-r1", "doubao-pro-32k"],
        "output_fields": ['顾客情绪', '一级原因', '二级原因', '具体原因', '客服亮点','建议客服接待策略']
    },
    "有效性回复分析": {
        "module": "reply_analysis",
        "allowed_columns": ["doubao-pro-32k", "deepseek-r1"],
...
if uploaded_file:
    ...
    with pd.ExcelWriter(output, engine='openpyxl') as writer:
        ...
        df[output_columns].to_excel(writer, index=False)
